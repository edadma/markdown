...
case class TableHeadCellAST( align: String, contents: AST ) extends BranchAST
case class TableBodyCellAST( align: String, contents: AST ) extends BranchAST
case class TableRowAST( contents: AST ) extends BranchAST
